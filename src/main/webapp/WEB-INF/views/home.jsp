...
<html>
	<head>
		...
		<script>
			$(document).ready(function() {
				...
				$("#fill_in_the_blank").click(function() {
					current_question = 0;
				    $.ajax({
				    	type: "GET",
				        url: "get/quiz",
				       ...
				       $('#fill_in_the_blank_answer1_img').attr('src',url_prefix + data[current_question].answers[0].imagePath);
				       $('#fill_in_the_blank_answer2').empty().append(data[current_question].answers[1].word);
				       $('#fill_in_the_blank_answer2_img').attr('src',url_prefix + data[current_question].answers[1].imagePath);
				       $('#fill_in_the_blank_answer3').empty().append(data[current_question].answers[2].word);
				       $('#fill_in_the_blank_answer3_img').attr('src',url_prefix + data[current_question].answers[2].imagePath);
				       $('#fill_in_the_blank_answer4').empty().append(data[current_question].answers[3].word);
				       $('#fill_in_the_blank_answer4_img').attr('src',url_prefix + data[current_question].answers[3].imagePath);
				    });					
				});
	...
	<div data-role="page" id="one" data-theme="<%= theme%>">
		...
		<div data-role="content" data-theme="<%= theme%>">	
			...
			<p><a href="#fill_in_the_blank" data-role="button" id="fill_in_the_blank">Fill in the blank</a></p>
			...
			<div class="ui-grid-c">
				<div class="ui-block-a">
					<div style="height:200px;text-align:center;">
						<img id="fill_in_the_blank_answer1_img" src="" style="height:200px;" />
					</div>
				</div>
				<div class="ui-block-b">
					<div style="height:200px;text-align:center;">
						<img id="fill_in_the_blank_answer2_img" src="" style="height:200px;" />
					</div>
				</div>
				<div class="ui-block-c">
					<div style="height:200px;text-align:center;">
						<img id="fill_in_the_blank_answer3_img" src="" style="height:200px;" />
					</div>
				</div>
				<div class="ui-block-d">
					<div style="height:200px;text-align:center;">
						<img id="fill_in_the_blank_answer4_img" src="" style="height:200px;" />
					</div>
				</div>
			</div><!-- /grid-b -->
			<fieldset class="ui-grid-c">
				<div class="ui-block-a"><a href="#" data-role="button" id="fill_in_the_blank_answer1" class="next_question"></a></div>
				<div class="ui-block-b"><a href="#" data-role="button" id="fill_in_the_blank_answer2" class="next_question"></a></div>
				<div class="ui-block-c"><a href="#" data-role="button" id="fill_in_the_blank_answer3" class="next_question"></a></div>
				<div class="ui-block-d"><a href="#" data-role="button" id="fill_in_the_blank_answer4" class="next_question"></a></div>
			</fieldset>
		</div><!-- /content -->
